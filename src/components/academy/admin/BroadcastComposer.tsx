...
export const BroadcastComposer = () => {
  ...
  const handleSendBroadcast = async () => {
    ...
    try {
      // Create community post if enabled
      if (alsoCreatePost) {
      ...
      // In a real app, you would trigger an email broadcast here
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Send an email to all {memberCount} community members
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="bg-muted/30 border-border/50 min-h-[250px] resize-none"
              />
            </div>
            ...
            <div className="flex items-center justify-between p-4 rounded-xl bg-muted/30 border border-border/50">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Create a pinned post with this content</p>
                </div>
              </div>
              <Switch
                checked={alsoCreatePost}
                onCheckedChange={setAlsoCreatePost}
              />
            </div>
            ...
            <div className="flex gap-3 pt-4">
              ...
              <Button
                ...
                disabled={!subject.trim() || !content.trim() || isSending || sent}
                className={cn(
                  "flex-1",
                  sent
        ...
        <motion.div
          initial={false}
          animate={{ opacity: showPreview ? 1 : 0.5 }}
        >
          <GlassCard hover={false} className="h-full">
            ...
            <div className="rounded-xl border border-border/50 overflow-hidden bg-white">
              ...
              <div className="bg-gradient-to-r from-primary to-secondary p-6 text-center">
                <h2 className="text-2xl font-bold text-white">SITA Academy</h2>
              </div>
            ...
            <div className="mt-4 flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>{memberCount} recipients</span>
      ...
      {/* Recent Broadcasts */}
      <GlassCard hover={false}>
        <h4 className="font-semibold text-foreground mb-4">Recent Broadcasts</h4>
